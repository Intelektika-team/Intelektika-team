...
| [**⚒️ Utitool**](https://github.com/Intelektika-team/Utitool) | `✅ Стабильная версия v1.0.0` | Мощная CLI-утилита с уникальной системой плагинов на Python для автоматизации и работы с системой. | [Руководство по плагинам](https://github.com/Intelektika-team/Utitool/wiki) |
...
*   **💾 Железо:** RP2040, ESP8266, Orange Pi, собственные печатные платы
